...
public class RNFirebaseMessagingService extends FirebaseMessagingService {
  ...
  public void onMessageReceived(RemoteMessage message) {
    ...
    // Resulticks Android Implementation
    if (isReNotification(message.getData()))
      return;
  ...
  private boolean isReNotification(Map<String, String> data) {
    try {
      if (data.containsKey("navigationScreen")) {
        Intent intent = new Intent();
        for (String value : data.keySet()) intent.putExtra(value, data.get(value));
